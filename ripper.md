...
![settings.png](img/ripper/settings.png)

Then, configure the path to the game executable and directory.

![launch-screen.png](img/ripper/launch-screen.png)
...
![game-not-logged-in.png](img/ripper/game-not-logged-in.png)

There will also be a new overlay in the top left that shows you that NinjaRipper is running in the background.

![ninjaripper-overlay.png](img/ripper/ninjaripper-overlay.png)
...
![cellar-map.png](img/ripper/cellar-map.png)
...
![character-preparation.png](img/ripper/character-preparation.png)
...
We will need it later in the [Blender import step](blender-cleanup.md#importing-the-model).

This is what it should look like:

![photo-mode-setup.png](img/ripper/photo-mode-setup.png)
...
With this, the model extraction will start, which might take a long time depending on the scene size and compute power available.
